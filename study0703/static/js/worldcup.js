...
"보르조이.jpg","봄베이.jpg","불테리어.jpg","브라아드.jpg","삽살개.jpg",
...
"바센지","발발이","보더콜리","보르조이","봄베이","불테리어","브라아드",
...
window.onload=function(){
    ...
    left.src="./static/image/"+image[순서[0]];
    right.src="./static/image/"+image[순서[1]];
    leftText.innerHTML=kind[순서[0]];
    rightText.innerHTML=kind[순서[1]];
}